  ...
  return (
    <PlayerProvider>
      <div className="flex h-screen bg-black text-white overflow-hidden font-sans selection:bg-green-500/30 relative">
        ...
        <main className="flex-1 overflow-y-auto bg-zinc-900 bg-gradient-to-b from-zinc-800 to-black relative overscroll-y-contain pt-[env(safe-area-inset-top,0px)] pb-[calc(11.5rem+env(safe-area-inset-bottom,0px))] md:pb-[calc(11.5rem+env(safe-area-inset-bottom,0px))]">
